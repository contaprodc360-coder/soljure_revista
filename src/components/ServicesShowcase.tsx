...
export const ServicesShowcase: React.FC = () => {
  ...
  const services: ServiceItem[] = [
    {
      id: 'contabilidad',
      title: 'Contabilidad Integral para Empresas',
      category: 'Corporativo',
      icon: <Briefcase className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&q=80&w=600',
      summary: 'Llevanza técnica de libros contables, balances generales, estados de resultados bajo estándares NIIF y conciliaciones estrictas.',
      fullDescription: 'Un proceso contable impecable es la columna vertebral de cualquier corporación exitosa. Diseñamos e implementamos sistemas de contabilidad automatizados, reportes de flujos de efectivo y análisis financieros mensuales para asegurar la máxima transparencia de tu negocio en el año 2026.',
      keyBenefits: ['Estados financieros listos para auditar', 'Análisis mensual de rentabilidad y liquidez', 'Conciliación bancaria automatizada sin errores', 'Cumplimiento rígido de normativas contables vigentes'],
      viralStat: '99.8%',
      viralStatLabel: 'Precisión en Balances',
      estimatedDuration: 'Continuo / Mensual'
    },
    {
      id: 'impuestos',
      title: 'Declaraciones de Impuestos Eficientes',
      category: 'Fiscal',
      icon: <FileText className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&q=80&w=600',
      summary: 'Elaboración y presentación del IVA, Impuesto a la Renta, retenciones en la fuente y anexos transaccionales bajo regulaciones del SRI.',
      fullDescription: 'Evita dolores de cabeza impositivos con nuestro servicio predictivo de rentas. Planificamos la carga fiscal utilizando el escudo impositivo permitido por la LORTI, asegurando la presentación a tiempo de todas tus obligaciones fiscales nacionales e internacionales.',
      keyBenefits: ['Maximización legal de deducciones autorizadas', 'Simulaciones previas al cierre fiscal anual', 'Cero recargos o multas por presentación tardía', 'Conciliación impecable de comprobantes electrónicos'],
      viralStat: '-25%',
      viralStatLabel: 'Carga impositiva legal optimizada',
      estimatedDuration: 'Mensual / Anual'
    },
    {
      id: 'auditorias',
      title: 'Auditorías de Gestión, Financieras e Internas',
      category: 'Auditoría',
      icon: <ShieldAlert className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=600',
      summary: 'Exámenes críticos y sistemáticos de tus libros contables y procesos operativos para mitigar riesgos de fraude u omisiones.',
      fullDescription: 'Nuestras auditorías integrales validan la razonabilidad de los saldos de tus estados financieros. Bajo la dirección científica del Mgst. Segundo Cuenca, identificamos debilidades en el control interno y proponemos correcciones antes de que se vuelvan contingencias.',
      keyBenefits: ['Dictámenes listos para entes reguladores', 'Evaluación profunda de riesgos operativos', 'Detección oportuna de fugas de capital', 'Recomendaciones de control interno de alto impacto'],
      viralStat: '100%',
      viralStatLabel: 'Eficacia en Dictámenes',
      estimatedDuration: 'Anual / Semestral'
    },
    {
      id: 'defensa_omisos',
      title: 'Defensa sobre Omisos y Sanciones Tributarias',
      category: 'Procesal',
      icon: <Scale className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=600',
      summary: 'Estrategia de impugnación, justificación técnica y descargos formales ante notificaciones coercitivas o multas impuestas por el SRI.',
      fullDescription: '¿Has recibido una notificación de cobro, glosa o fuiste declarado omiso? Reconstruimos la trazabilidad probatoria y lideramos la defensa técnica basándonos en la realidad económica, logrando mitigar o cancelar multas injustificadas y procesos de coactivas.',
      keyBenefits: ['Impugnación de glosas administrativas del SRI', 'Suspensión legal de cobros bajo el COGEP', 'Asistencia profesional en procesos de fiscalización activa', 'Reducción sustancial de sanciones y recargas históricas'],
      viralStat: '$0',
      viralStatLabel: 'Multas persistentes gracias a defensa justa',
      estimatedDuration: 'Inmediata / Horas Críticas'
    },
    {
      id: 'constitucion_cia',
      title: 'Constitución, Creación y Cancelación de Cías',
      category: 'Societario',
      icon: <Building className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=600',
      summary: 'Estructuración jurídica societaria y disoluciones. Creamos compañías SAS, S.A., o de Responsabilidad Limitada con agilidad.',
      fullDescription: 'Te acompañamos en todo el ciclo de vida societario. Desde el diseño de estatutos de una compañía SAS moderna y flexible, hasta el proceso ordenado de cancelación o liquidación ante la Superintendencia de Compañías para evitar saldos arrastrados indeseados.',
      keyBenefits: ['Constitución flexible de empresas SAS sin capital mínimo exigido', 'Asesoría en la elección de tipo societario (SAS, SA o Limitada)', 'Estatutos redactados a medida protegiendo socios', 'Liquidación expedita libre de trabas imprevistas'],
      viralStat: '48h',
      viralStatLabel: 'Plazo habitual p/ creación SAS',
      estimatedDuration: 'De 2 a 15 días laborables'
    },
    {
      id: 'roles_pago',
      title: 'Roles de Pago y Gestión de Planillas',
      category: 'Operaciones',
      icon: <Users className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&q=80&w=600',
      summary: 'Estructuración quincenal y mensual de roles, provisiones de décimos, liquidación de haberes y cálculo de horas extras.',
      fullDescription: 'Olvídate de cometer errores en la nómina de tu equipo. Automatizamos el cálculo completo del rol de pagos, descuentos correspondientes por ley y emisión oportuna de los volantes de pago individuales cumpliendo las normas del Ministerio del Trabajo.',
      keyBenefits: ['Cálculo exacto de horas suplementarias y extraordinarias', 'Emisión electrónica de comprobantes de pago detallados', 'Provisiones contables automáticas de 13ro y 14to sueldo', 'Mitigación de demandas por actas de finiquito incorrectas'],
      viralStat: '0%',
      viralStatLabel: 'Conflictos Laborales',
      estimatedDuration: 'Mensual / Quincenal'
    },
    {
      id: 'seguridad_social',
      title: 'Seguridad Social (IESS) y Cumplimiento',
      category: 'Operaciones',
      icon: <CheckCircle className="w-6 h-6" />,
      imageUrl: 'https://images.unsplash.com/photo-1544383835-bda2bc66a55d?auto=format&fit=crop&q=80&w=600',
      summary: 'Novedades de entrada y salida, planillas mensuales de aportaciones, fondos de reserva y trámites generales ante el IESS.',
      fullDescription: 'La afiliación al Seguro Social es obligatoria y altamente fiscalizada. Gestionamos el portal del IESS para ingresos de personal, avisos de accidentes de trabajo, jubilaciones, y préstamos quirografarios para tus colaboradores sin generar deudas patronales.',
      keyBenefits: ['Evita glosas patronales extremas por afiliación incorrecta', 'Reporte inmediato de avisos de entrada y salida', 'Conciliación precisa de planillas con el rol contable', 'Asesoría en fondos de reserva y utilidades acumuladas'],
      viralStat: '100%',
      viralStatLabel: 'Cumplimiento del Seguro Social',
      estimatedDuration: 'Continuo / Mensual'
    }
  ];
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    phone: '',
    serviceName: 'Declaraciones de Impuestos Eficientes',
    message: ''
  });
    ...
    try {
      ...
      setTimeout(() => {
        ...
        setFormData({
          ...
          email: '',
          phone: '',
          serviceName: selectedService ? selectedService.title : 'Declaraciones de Impuestos Eficientes',
          message: ''
        });
